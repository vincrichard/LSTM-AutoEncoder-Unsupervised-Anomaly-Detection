...
class LSTMAutoEncoder(nn.Module):
    def __init__(self, num_layers, batch_size, hidden_size, nb_feature, dropout=0, device=torch.device('cpu')):
        super(LSTMAutoEncoder, self).__init__()

        self.encoder = Encoder(num_layers, batch_size, hidden_size, nb_feature, dropout, device)
        self.decoder = Decoder(num_layers, batch_size, hidden_size, nb_feature, dropout, device)
